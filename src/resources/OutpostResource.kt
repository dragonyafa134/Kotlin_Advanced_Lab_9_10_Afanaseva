...
fun main(){
    ...
    println("Успех! Вы добили дополнительно количество миниралов ${mineral.amount + 50}")
    val bonusMineral = mineral.copy(id = 3, "Minerals Bonus", amount = mineral.amount + 50)
